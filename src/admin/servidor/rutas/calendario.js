...
router.post('/', async (req, res) => {
  ...
  if (repeticion && parseInt(repeticion) !== 0 && !repeticion_fin)
    return res.status(400).json({ ok: false, error: 'repeticion_fin es requerido cuando hay repetición' })
...
router.put('/:id', async (req, res) => {
  ...
  if (repeticion != null && parseInt(repeticion) !== 0 && !repeticion_fin)
    return res.status(400).json({ ok: false, error: 'repeticion_fin es requerido cuando hay repetición' })
